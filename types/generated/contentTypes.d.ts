...
export interface ApiNewssNewss extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    language: Schema.Attribute.Enumeration<['ru, kk, en']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedA: Schema.Attribute.Date &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiVacancycVacancyc extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    statuss: Schema.Attribute.Enumeration<['active', 'closed']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
